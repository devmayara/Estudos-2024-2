 ...
 *
 * E.g.
 *     ../../images/icon.jpg relative to /js/imports/icons.js
 * becomes
 *     ../images/icon.jpg relative to /js/minified.js
 *
...
class Converter implements ConverterInterface
{
    ...
    protected function normalize($path)
    {
        ...
        /*
         * Example:
         *     /home/forkcms/frontend/cache/compiled_templates/../../core/layout/js/../images/img.gif
         * to
     ...
     *
     * E.g.
     *     ../images/img.gif relative to /home/forkcms/frontend/core/layout/js
     * should become:
