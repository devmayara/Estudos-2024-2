...
class Web extends Controller
{
    ...
    public function blogSearch(array $data): void
    {
        ...
        $search = filter_var($data['term'], FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    public function forget(?array $data): void
    {
        if (!empty($data['csrf'])) {
            ...
            if ($auth->forget($data['email'])) {
                $json['message'] = $this->message->success("Acesse seu email para redefinir sua senha")->render();
            } else {
                $json['message'] = $auth->message()->render();
            }
    ...
    public function register(?array $data): void
    {
        if (!empty($data['csrf'])) {
            if (!csrf_verify($data)) {
                $json["message"] = $this->message->error("Erro ao enviar, por favor use o formulário")->render();
                echo json_encode($json);
                return;
            }
    ...
    public function confirm(): void
    {
        ...
        echo $this->view->render("optin", [
            ...
            "data" => (object)[
                ...
                "desc" => "Enviamos um link de confirmação para seu e-mail. Acesse e siga as instruções para 
                            concluir seu cadastro e comece a controlar com o " . CONF_SITE_NAME,
